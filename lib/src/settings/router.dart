...
final router = GoRouter(
  ...
  routes: [
    GoRoute(
        path: AuthCheckView.ROUTE,
        builder: (context, state) => const AuthCheckView()),
    GoRoute(
        path: PresentationView.ROUTE,
    ...
    GoRoute(
        path: HomeView.ROUTE, builder: (context, state) => const HomeView()),
    GoRoute(
        path: NewPostView.ROUTE,
        builder: (context, state) => const NewPostView()),
    GoRoute(
        path: ProfileView.ROUTE,
        builder: (context, state) =>
            ProfileView(userId: state.extra as String?)),
    GoRoute(
        path: SettingsView.ROUTE,
        builder: (context, state) => const SettingsView()),
    GoRoute(
      path: PostView.ROUTE,
      builder: (context, state) => PostView(postId: state.extra as String),
    ),
  ],
